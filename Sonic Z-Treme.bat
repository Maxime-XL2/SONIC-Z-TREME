...
set pj_name="Projects\SONIC Z-TREME"

set testdir=%workdir%\%pj_name%\cd\
set testbin=%workdir%\%pj_name%\cd\0.bin
...
set satlink_path=%workdir%\..
if exist SatLink\SatLink.exe set satlink_path=%workdir%\SatLink
cd %satlink_path%
